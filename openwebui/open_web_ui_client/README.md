# open-web-ui-client
A client library for accessing Open WebUI

## Usage
First, create a client:

```python
from open_web_ui_client import Client
...
```python
from open_web_ui_client import AuthenticatedClient
...
```python
from open_web_ui_client.models import MyDataModel
from open_web_ui_client.api.my_tag import get_my_data_model
from open_web_ui_client.types import Response
...
1. Any endpoint which did not have a tag will be in `open_web_ui_client.api.default`
